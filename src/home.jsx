...
export default function Home() {
    ...
    const handleBlock = () => {
        axios.put(`http://localhost:8080/users/block`, { userIds: selectedIds })
            .then(response => {
    ...
    const handleUnblock = () => {
        axios.put(`http://localhost:8080/users/unblock`, { userIds: selectedIds })
            .then(response => {
    ...
    const handleDelete = () => {
        axios.delete('http://localhost:8080/users', { data: { userIds: selectedIds } })
            .then(response => {
    ...
    return (
        <div className="container bg-light py-4">
            <div className="d-flex justify-content-between align-items-center my-3">
                <h1 className="text-center">Welcome to User Management System!</h1>
